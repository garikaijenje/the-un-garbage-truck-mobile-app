...
export default function About({navigation}) {
  return (
    <Container>
      ...
      <Content>
          <View style={tailwind('flex-1 pt-10 pb-0')}>
          
          <ScrollView >

            <View style={tailwind('p-5')}>

              <Text style={tailwind('mb-5 text-xl text-black text-justify')}>
            ...
            <View style={tailwind('justify-between px-5 items-center flex-row h-20 w-full bg-secondary rounded-tr-large rounded-tl-large')}>
              <View style={tailwind('')}>
                <Text style={tailwind('text-2xl font-bold text-primary')}>Contact Us</Text>
                <Text style={tailwind('text-primary font-bold')} >Send us an email to hello@ungarbagetruck.com</Text>
              </View>
              <View>
